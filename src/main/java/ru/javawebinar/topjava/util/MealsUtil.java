...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static List<MealWithExceed> getWithExceeded(List<Meal> list, int caloriesPerDay) {
        return getFilteredWithExceeded(list, LocalTime.MIN, LocalTime.MAX, caloriesPerDay);
    }
